...
-- ============================================
-- 12. Privacy: лични данни само за логнати + треньорски PIN достъп
-- ============================================

-- Анонимните (публичният сайт) виждат само колоните за заетост на bookings —
-- личните данни (customer_name/email/phone, notes) изискват логнат потребител.
...
-- Отмяна на СОБСТВЕНА бъдеща резервация от треньор, след проверка на PIN
